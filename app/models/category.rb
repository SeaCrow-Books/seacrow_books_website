...
class Category < ApplicationRecord
  ...
  has_many :child_categories, class_name: 'Category', foreign_key: 'parent_id', inverse_of: :parent_category
  belongs_to :parent_category, class_name: 'Category', optional: true, foreign_key: 'parent_id', inverse_of: :child_categories
